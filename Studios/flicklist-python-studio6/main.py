...
class MovieRatings(Handler):
    ...
    def get(self):
        ...
        watched_movies = db.GqlQuery("SELECT * FROM Movie where watched = True ORDER BY created ASC") # type something else instead of an empty list
    ...
    def post(self):
        ...
        # TODO 2
        # retrieve the movie entity whose id is movie_id
